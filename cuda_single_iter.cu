 ...
 *
 * Operate on just one entry of the array.
 */
__global__ void k_axpy_single_iter(int n, float a, float *x, float *y) {
...
int main(int argc, char **argv) {
  ...
  /* warm-up run */
  k_axpy_single_iter<<< nb, nt >>>(length, 1.0, d_x, d_y);
  /* begin timing */
